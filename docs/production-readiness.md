...
| Integration/E2E tests (real HTTP + Postgres, browser smoke) | ✅ 423 unit + 240 integration against real Postgres+pgvector (both measured on this commit) + the browser flow, all gate CI | ✅ | ✅ |
