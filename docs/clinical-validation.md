...
| **The live index is coherent** | Production reports **2,760 chunks**, all embedded by the active provider, against a matching vector column. No stale or orphaned chunks. All 2,760 sit on the **5 ACTIVE documents** and all five are retrievable — reconciled chunk by chunk in `docs/production-corpus-audit.md` (inventory read 2026-09-23). Source: the API's boot log on Railway deployment `598377b9` (commit `9eb03d6`, 2026-09-22T12:40:01Z): `Embedding index: provider="openai-embedding" chunks=2760 staleRetrievable=0 staleOrphaned=0 columnDimensions=384 refusalThreshold=0.25`. (Earlier readings: 725 at go-live 2026-08-22, 2,706 on 2026-09-14. The corpus grows; re-read the boot log rather than trusting this figure.) |
...
| Corpus | 4 seeded demo documents | 2,760 chunks (2026-09-22 boot log of `9eb03d6`; 2,706 on 09-14, 725 at go-live) |
