...
| `npm test` | ✅ **439 tests, 31 suites, 0 failures**, 9.8 s |
...
| `api` | build shared → build API → **439 unit tests** → migrations against a real `pgvector/pgvector:pg16` → create `bnp_e2e` via the `pg` client → **integration tests** |
