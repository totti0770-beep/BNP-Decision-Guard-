...
**The file-by-file audit is 120 of 231 — it is not finished.** Any statement in
...
whole tree and is as true at 120 files read as at 231. A described fact — what a
service does, why a comment says what it says — requires the file to have been
opened, and only 120 have.
...
The remaining 111 files, read in the batches named in the plan, each appended to
