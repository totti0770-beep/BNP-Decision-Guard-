...
**The file-by-file audit is 64 of 230 — it is not finished.** Any statement in
...
whole tree and is as true at 64 files read as at 230. A described fact — what a
service does, why a comment says what it says — requires the file to have been
opened, and only 64 have.
...
The remaining 166 files, read in the batches named in the plan, each appended to
