...
**The file-by-file audit is 105 of 231 — it is not finished.** Any statement in
...
whole tree and is as true at 105 files read as at 231. A described fact — what a
service does, why a comment says what it says — requires the file to have been
opened, and only 105 have.
