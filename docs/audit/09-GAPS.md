...
**The file-by-file audit is 193 of 231 — it is not finished.** One area is:
...
whole tree and is as true at 193 files read as at 231. A described fact — what a
service does, why a comment says what it says — requires the file to have been
opened, and only 193 have.
...
The remaining 38 files, read in the batches named in the plan, each appended to
